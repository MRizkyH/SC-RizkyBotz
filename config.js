...
global.sig1 = 'https://wa.me/6288295230313?text=_Assalamualaikum+🙏🏻_'
...
/*============== PAYMENT ==============*/
global.pdana = '62881024859298' //Nomor dana atay gooay kalian
global.povo = '-' 
global.pgopay = '-'
global.ppulsa = '6281286022278' // Smartfren : kalau gada diganti tanda - aja
global.ppulsa2 = '-' // tri : kalau gada diganti tanda - aja
global.psaweria = 'https://saweria.co/MRizkyH'

/*============== NOMOR ==============*/
global.nomorbot = '62881024859298'
global.nomorown = '6288295230313' // nomor owner
global.namebot = 'RizkyBotz'
global.nameown = 'M ℜ𝔦𝔷𝔨𝔶 H🌃'


/*============== STAFF ==============*/
global.owner = [
  ['6288295230313', 'Rizky', true],//Ganti jd nomormu sama Namamu dan tanda ( ' ) jangan di hapus', 'Zenz', true],//Ganti jd nomormu sama Namamu dan tanda ( ' ) jangan di hapus
  ['6288295230313', 'Developer Bot', true] //Jangan di Ganti🚫
  ]
...
/*============== WATERMARK ==============*/
global.wm = '☪ Rizky BotzMD'
global.botdate = `\n© Rizky BOT - ${week}, ${date}\n`//⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}, ${week}, ${date}
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `WhatsApp Bot | By M ℜ𝔦𝔷𝔨𝔶 H🌃`
global.author = '\n© Rizky BotzMD'
...
/*============== TEXT ==============*/
global.wait = 'ᴡᴀɪᴛ.. ᴛᴜɴɢɢᴜ sᴇᴊᴀᴍ:v'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Rizky Bot MD'
global.stickauth = `RizkyBotz Sticker`
